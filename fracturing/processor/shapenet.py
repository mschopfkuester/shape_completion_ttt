...
class ShapeNetObject(database.DatabaseObject):
    ...
    def path_c_uniform_occ(self, idx=0):
        return self.path("models", "model_c_{}_uniform_occ.npz".format(idx))

    def path_c_sdf(self, idx=0):
        return self.path("models", "model_c_{}_sdf.npz".format(idx))

    def path_c_uniform_sdf(self, idx=0):
        return self.path("models", "model_c_{}_uniform_sdf.npz".format(idx))
    ...
    def path_primitive(self, idx=0):
        return self.path("models", "model_primitive_{}.obj".format(idx))
