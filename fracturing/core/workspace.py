...
def get_model_params_dir(experiment_dir, create_if_nonexistent=False,model_params_subdir = "ModelParameters"):
...
def get_optimizer_params_dir(experiment_dir, create_if_nonexistent=False,optimizer_params_subdir = "OptimizerParameters"):
...
def get_latent_codes_dir(experiment_dir, create_if_nonexistent=False,latent_codes_subdir = "LatentCodes"):
