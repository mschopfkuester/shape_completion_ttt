...
def main(k_obj,datadir_1,datadir_2,train_test_file,model_path,obj_class,lr_schedule=None):
    path_deepmend=os.getcwd()

    f=open(train_test_file)
    test_dict=json.load(f)['id_test_list']

    experiment_dir=os.path.join('experiments',obj_class)
    ...
    for k,id in enumerate(test_dict[:]):
        ...
        json_dict=os.path.join(datadir_1,'{}_split_single_{}.json'.format(obj_class,k))
        ...
        outfile_train=os.path.join(datadir_1,'{}_train_single_{}.pkl'.format(obj_class,k))
        outfile_test=os.path.join(datadir_1,'{}_test_single_{}.pkl'.format(obj_class,k))
        ...
        outfile_train_2=os.path.join(datadir_2,'{}_train_single_{}.pkl'.format(obj_class,k))
        outfile_test_2=os.path.join(datadir_2,'{}_test_single_{}.pkl'.format(obj_class,k))
        ...
        torch.save(model,os.path.join(path_deepmend,'experiments',obj_class,'ModelParameters/begin_{}.pth'.format(k)))

        shutil.copy(os.path.join(path_deepmend,'experiments',obj_class,'LatentCodesInference1','{}.pth'.format(k)),os.path.join(path_deepmend,'experiments',obj_class,'LatentCodes','begin_{}.pth'.format(k)))
        shutil.copy(os.path.join(path_deepmend,'experiments',obj_class,'LatentCodesInference1','{}_tool.pth'.format(k)),os.path.join(path_deepmend,'experiments',obj_class,'LatentCodes','begin_{}_tool.pth').format(k))
        ...
        train_source_path=os.path.join(datadir_2,'{}_train_single_{}.pkl'.format(obj_class,k))
        ...
        shutil.copy(os.path.join(path_deepmend,'experiments',obj_class,'ModelInference','{}_model.pth'.format(k)),os.path.join(path_deepmend,'experiments',obj_class,'ModelParameters','inference_{}.pth'.format(k)))

        #load latent codes directly via optional parameter in function
        latent_path=os.path.join(path_deepmend,'experiments',obj_class,'ModelInference','{}_lat.pth'.format(k))
        tool_latent_path=os.path.join(path_deepmend,'experiments',obj_class,'ModelInference','{}_tool_lat.pth'.format(k))
        ...
        network_kwargs = dict(
            ...
            checkpoint='inference_{}'.format(k),#args.checkpoint,
        )
        ...
        reconstruction_handler = core.handler.ReconstructionHandler(
            ...
            dims=[256, 256, 256],
            name=name,
            checkpoint='inference_{}'.format(k),
            overwrite=False,
            use_occ=specs["UseOccupancy"],
            signiture=[],
        )
        sdf_dataset = core.data.SamplesDataset(
            os.path.join(datadir_1,'{}_test_single_{}.pkl'.format(obj_class,k)), #test_split_file,
        ...
        shutil.copy(os.path.join(path_deepmend,experiment_dir,'Reconstructions','{}@inference_{}'.format(obj_class,k),'Meshes','0_0_.obj'),os.path.join(path_deepmend,experiment_dir,'Reconstructions_end','{}_0_.obj'.format(k)))
        shutil.copy(os.path.join(path_deepmend,experiment_dir,'Reconstructions','{}@inference_{}'.format(obj_class,k),'Meshes','0_1_.obj'),os.path.join(path_deepmend,experiment_dir,'Reconstructions_end','{}_1_.obj'.format(k)))
        shutil.copy(os.path.join(path_deepmend,experiment_dir,'Reconstructions','{}@inference_{}'.format(obj_class,k),'Meshes','0_2_.obj'),os.path.join(path_deepmend,experiment_dir,'Reconstructions_end','{}_2_.obj'.format(k)))
...
if __name__ == "__main__":
    ...
    main(args.k_obj,args.datadir_1,args.datadir_2,args.train_test_file,args.path_model,args.obj_class)
