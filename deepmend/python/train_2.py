...
train_test_file='/home/michael/Projects/test_shapeNet/ShapeNet/ShapeNetCore.v2/split_original/mugs_split_firststep_correct.json'
...
for k,id in enumerate(test_dict[:]):
    ...
    shutil.copy(os.path.join(path_deepmend,experiment_dir,'Reconstructions','ours_@inference','Meshes','0_0_.obj'),os.path.join(path_deepmend,experiment_dir,'Reconstructions_experimental_1','{}_0_.obj'.format(k)))
    shutil.copy(os.path.join(path_deepmend,experiment_dir,'Reconstructions','ours_@inference','Meshes','0_1_.obj'),os.path.join(path_deepmend,experiment_dir,'Reconstructions_experimental_1','{}_1_.obj'.format(k)))
    shutil.copy(os.path.join(path_deepmend,experiment_dir,'Reconstructions','ours_@inference','Meshes','0_2_.obj'),os.path.join(path_deepmend,experiment_dir,'Reconstructions_experimental_1','{}_2_.obj'.format(k)))
